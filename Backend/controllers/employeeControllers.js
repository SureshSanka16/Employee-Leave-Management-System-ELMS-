...
const checkemployeelogin = async (req, res) => {
  ...
  try {
    ...
    if (password !== employee.EmployeePassword && employee.EmployeePassword!=="Active") {
     ...
     const token = generateToken({ employeeID: employee.EmployeeId, role: "employee" });
...
const applyLeave = async (req, res) => {
  try {
    const EmployeeID = req.params.ID;  // get EmployeeID from URL param
    const { LeaveType, LeaveStart, LeaveEnd, LeaveMessage } = req.body;
    ...
    // Create leave without any file upload
