  ...
  export default function EmployeeProfile() {
    ...
    const [profile, setProfile] = useState(""); // src for avatar
      ...
      try {
        ...
        let defaultProfile =
          empdata.EmployeeGender === "Male"
            ? "/media/profiles/male.jpg"
            : "/media/profiles/female.jpg";
        ...
        setProfile("/media/profiles/Not_Uploaded.jpg"); // fallback
      }
    };
  ...
  src={
      ...
      employeeData?.EmployeeGender === "Male"
      ? "/profiles/male.jpg"
      : "/profiles/female.jpg"
  }
  alt="avatar"
